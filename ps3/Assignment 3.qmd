...
> Now explore the use of Hidden Markov Models to answer to the research question. Briefly support the choice of this model to answer the research question.
  Discuss (briefly but clearly) results and limitations.
