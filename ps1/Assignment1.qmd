...
```{r}
data_sub <- data[1:51,]
data_ts_sub <- ts(as.vector(t(data_sub)), start = c(1880,1), frequency = 12)
```
...
```{r}
data_ts_sub <- data_ts_sub[is.finite(data_ts_sub)]
HWdata <- HoltWinters(data_ts_sub, beta=F, gamma=F)
plot(HWdata)
alpha <- HWdata$alpha
alpha
```
...
data_ts_sub_2 <- data_ts_sub[-1]
#MAE
mean(abs(data_ts_sub_2-yhat))
#MAPE
mean(abs(data_ts_sub_2-yhat)/data_ts_sub_2)
#MSE
mean(abs(data_ts_sub_2-yhat)^(2))
```
...
#alpha 0.1
HWdata_01 <- HoltWinters(data_ts_sub, alpha=.1, beta=F, gamma=F)
plot(HWdata_01)
#alpha 0.3
HWdata_03 <- HoltWinters(data_ts_sub, alpha=.3, beta=F, gamma=F)
plot(HWdata_03)
#alpha 0.1
plot(HWdata)
#alpha 0.7
HWdata_07 <- HoltWinters(data_ts_sub, alpha=.7, beta=F, gamma=F)
plot(HWdata_07)
#alpha 0.9
HWdata_09 <- HoltWinters(data_ts_sub, alpha=.9, beta=F, gamma=F)
plot(HWdata_09)
