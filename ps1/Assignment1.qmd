...
ggplot(smoothed_long, aes(x = time, y = Value, color = Series)) +
  ...
  scale_color_manual(values = c("black", "blue", "red", "black", "purple")) +  # Custom colors
...
#### NOTES
  ...
  - Sistema la flat prediction 
  - Capisci come (step precedente)
  
#### 2.4.1 Comment on 2.4
