...
res_raw <- dropFirst(res_raw)
pred_se <- dropFirst(pred_se)

# Align temp to match dimensions
temp_sub <- temp[-1, ]  # drop first obs of temp

# Reconstruct the prediction properly
y_pred <- temp_sub - res_raw
