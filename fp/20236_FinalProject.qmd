...
plot(time(ts_gistemp_ds), estStates\$state, type = "l", ylab = "Estimated State", xlab = "Time", main = "Estimated Hidden States over Time (2-state HMM)", col = "firebrick", lwd = 1.5)
```
