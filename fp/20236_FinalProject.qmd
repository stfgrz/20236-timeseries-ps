...
### 2.1.a 2-states HMM and 3-states HMM

```{r}
#| label: 2-states HMM and 3-states HMM
...
print(p)
```
### 2.b 2-state and 3-state linear HMM
...
### 2.2.a Model 1: linear + seasonality
...
### 2.2.c Model 3: Randow walk + Noise
